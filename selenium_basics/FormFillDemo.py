...
driver.get(url)
driver.find_element(
    By.XPATH, "//input[@id='my-text-id']").send_keys("This is text")
driver.find_element(
    By.XPATH, "//input[@name='my-password']").send_keys("password")
driver.find_element(
    By.XPATH, "//textarea[@name='my-textarea']").send_keys("This is textarea")

disabled_element = driver.find_element(
    By.XPATH, "//input[@placeholder='Disabled input']")
print("text is disabled: ", disabled_element.is_enabled())

readonly_element = driver.find_element(
